...
import com.indevo.shop.KelineApplication
import com.indevo.shop.data.User
import com.indevo.shop.utils.RegisterValidation
import com.indevo.shop.utils.Resource
import com.indevo.shop.utils.validateEmail
...
class UserAcountViewModel  constructor(
    ...
    private fun saveUserInformation(user: User, shouldRetrievedOldImage: Boolean) {
        firestore.runTransaction { transaction ->
            ...
            viewModelScope.launch {
                _updateInfo.emit(Resource.Sucess(user))
            }
        }.addOnFailureListener {
            viewModelScope.launch {
